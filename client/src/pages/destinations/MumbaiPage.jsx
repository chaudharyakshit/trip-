...
const MumbaiPage = () => {
  ...
  const mumbaiImages = [mumbai1, mumbai2, mumbai3];
        ...
        <div className="content-grid">
          ...
          <div className="left-column">
            ...
            <section className="about-section">
              ...
              <p>
                Mumbai, India's financial capital and the heart of Bollywood, is a city of dreams that never sleeps. From colonial-era architecture and bustling markets to serene beaches and glamorous film studios, Mumbai offers a perfect blend of historic charm and modern vibrancy that captures the spirit of contemporary India.
              </p>
              ...
              <div className="package-details">
                ...
                <div className="detail-item">
                  ...
                  <span className="value">Local Train, Taxi, Ferry</span>
                </div>
                <div className="detail-item">
                ...
                <div className="detail-item">
                  ...
                  <span className="value">Bollywood Tour, Island Cruise</span>
                </div>
                <div className="detail-item">
                ...
                <div className="detail-item">
                  ...
                  <span className="value">Urban, Cultural, Entertainment</span>
                </div>
              </div>
            </section>
            ...
            <section className="highlights-section">
              ...
              <div className="highlights-list">
                <div className="highlight-item">
                  ...
                  Gateway of India – Iconic arch monument and waterfront promenade
                </div>
                <div className="highlight-item">
                  <span className="check">✓</span>
                  Marine Drive – Queen's Necklace with breathtaking sunset views
                </div>
                <div className="highlight-item">
                  <span className="check">✓</span>
                ...
                <div className="highlight-item">
                  <span className="check">✓</span>
                  Bollywood Studio Tour – Behind-the-scenes look at Indian film industry
                </div>
                <div className="highlight-item">
                  <span className="check">✓</span>
                  Dhobi Ghat – World's largest open-air laundry and unique photo opportunity
                </div>
              </div>
            </section>
            ...
            <section className="itinerary-section">
              ...
              <div className="itinerary-list">
                <div className="departure-point">
                  <span className="location">South Mumbai, India</span>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Colonial Mumbai – Gateway of India, Taj Hotel & Colaba</h4>
                </div>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Marine Drive & Chowpatty – Beach experience & street food</h4>
                </div>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Elephanta Island – Ferry ride & ancient cave temples</h4>
                </div>

                <div className="departure-point">
                  <span className="location">Film City, Mumbai</span>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Bollywood Experience – Film studio tour & Bollywood dance</h4>
                </div>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Markets & Local Life – Crawford Market & Dhobi Ghat visit</h4>
                </div>
              </div>
            </section>
          </div>
          ...
          <div className="right-column">
            <div className="booking-widget">
              <div className="price-section">
                <a href="https://wa.me/919695947578?text=Hi, I'm interested in the Mumbai tour package. Please share the pricing details." target="_blank" className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-lg font-semibold text-lg transition-colors inline-block text-center w-full">
                  Price on Request
                </a>
              </div>
