...
const DelhiPage = () => {
  ...
  const delhiImages = [delhi1, delhi2, delhi3];
        ...
        <div className="content-grid">
          ...
          <div className="left-column">
            ...
            <section className="about-section">
              ...
              <p>
                Delhi, India's capital territory, is a city that beautifully blends ancient history with modern dynamism. From magnificent Mughal monuments and British-era architecture to bustling markets and vibrant street food culture, Delhi offers a captivating journey through India's rich heritage and contemporary urban life.
              </p>
              ...
              <div className="package-details">
                ...
                <div className="detail-item">
                  ...
                  <span className="value">Metro, Car, Auto</span>
                </div>
                <div className="detail-item">
                ...
                <div className="detail-item">
                  ...
                  <span className="value">Heritage Walk, Food Tour</span>
                </div>
                <div className="detail-item">
                ...
                <div className="detail-item">
                  ...
                  <span className="value">Heritage, Cultural, Urban</span>
                </div>
              </div>
            </section>
            ...
            <section className="highlights-section">
              ...
              <div className="highlights-list">
                ...
                <div className="highlight-item">
                  <span className="check">✓</span>
                  India Gate – War memorial and iconic landmark of Delhi
                </div>
                <div className="highlight-item">
                  <span className="check">✓</span>
                ...
                <div className="highlight-item">
                  <span className="check">✓</span>
                  Chandni Chowk – Historic market and street food paradise
                </div>
                <div className="highlight-item">
                  <span className="check">✓</span>
                  Lotus Temple – Stunning Bahá'í House of Worship
                </div>
              </div>
            </section>
            ...
            <section className="itinerary-section">
              ...
              <div className="itinerary-list">
                ...
                <div className="day-item completed">
                  ...
                  <h4>Old Delhi – Red Fort, Jama Masjid & Chandni Chowk</h4>
                </div>
                ...
                <div className="day-item completed">
                  ...
                  <h4>New Delhi – India Gate, Rashtrapati Bhavan & Parliament</h4>
                </div>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Historical Sites – Qutub Minar & Humayun's Tomb</h4>
                </div>

                <div className="departure-point">
                  <span className="location">Delhi City</span>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Spiritual Delhi – Lotus Temple & Akshardham Temple</h4>
                </div>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Markets & Food – Dilli Haat & Street Food Tour</h4>
                </div>
              </div>
            </section>
          </div>
          ...
          <div className="right-column">
            <div className="booking-widget">
              <div className="price-section">
                <a href="https://wa.me/919695947578?text=Hi, I'm interested in the Delhi tour package. Please share the pricing details." target="_blank" className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-lg font-semibold text-lg transition-colors inline-block text-center w-full">
                  Price on Request
                </a>
              </div>
