...
const VaranasiPage = () => {
  ...
  const varanasiImages = [varanasi1, varanasi2, varanasi3];
  ...
  return (
    <div className="inner-page">
      ...
      <section className="hero-section">
        ...
        >
          {varanasiImages.map((img, index) => (
            <SwiperSlide key={index}>
              <div className="hero-slide">
                <img
                  src={img}
                  alt={`Varanasi ${index + 1}`}
            ...
            <section className="about-section">
              ...
              <div className="package-details">
                ...
                <div className="detail-item">
                  ...
                  <span className="value">English, Hindi, Bhojpuri</span>
                </div>
                <div className="detail-item">
                  <span className="label">Activities</span>
                  <span className="value">Boat Ride, Temple Tour, Yoga</span>
                </div>
                <div className="detail-item">
            ...
            <section className="highlights-section">
              ...
              <div className="highlights-list">
                <div className="highlight-item">
                  ...
                  Ganga Aarti Ceremony – Mesmerizing evening fire ritual at Dashashwamedh Ghat
                </div>
                <div className="highlight-item">
                  <span className="check">✓</span>
                  Morning Boat Ride – Sunrise cruise on the Ganges with spiritual atmosphere
                </div>
                <div className="highlight-item">
                  <span className="check">✓</span>
                  Kashi Vishwanath Temple – Visit one of Hinduism's most sacred Jyotirlinga temples
                </div>
                <div className="highlight-item">
                  <span className="check">✓</span>
                ...
                <div className="highlight-item">
                  <span className="check">✓</span>
                  Ancient Alley Exploration – Walk through narrow lanes filled with temples and shops
                </div>
              </div>
            </section>
            ...
            <section className="itinerary-section">
              ...
              <div className="itinerary-list">
                <div className="departure-point">
                  <span className="location">Varanasi, Uttar Pradesh</span>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Morning Ganga – Sunrise boat ride and ghat exploration</h4>
                </div>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Evening Aarti – Ganga Aarti ceremony at Dashashwamedh Ghat</h4>
                </div>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Kashi Vishwanath – Temple visit and spiritual walk</h4>
                </div>

                <div className="departure-point">
                  <span className="location">Sarnath</span>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Buddhist Heritage – Sarnath ruins, museum and Dhamek Stupa</h4>
                </div>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Old City Walk – Narrow lanes, local markets and silk weaving</h4>
                </div>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Spiritual Practices – Yoga session and traditional rituals</h4>
                </div>
              </div>
            </section>
          </div>
