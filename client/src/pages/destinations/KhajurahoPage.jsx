...
const KhajurahoPage = () => {
  ...
  const khajurahoImages = [khajuraho1, khajuraho2, khajuraho3];
  ...
  return (
    <div className="inner-page">
      ...
      <section className="hero-section">
        ...
        >
          {khajurahoImages.map((img, index) => (
            <SwiperSlide key={index}>
              <div className="hero-slide">
                <img
                  src={img}
                  alt={`Khajuraho ${index + 1}`}
        ...
        <div className="content-grid">
          ...
          <div className="left-column">
            ...
            <section className="about-section">
              ...
              <p>
                Khajuraho, a UNESCO World Heritage Site, is renowned for its magnificent group of Hindu and Jain temples adorned with intricate erotic sculptures. These architectural marvels from the Chandela dynasty showcase the pinnacle of medieval Indian art and craftsmanship. Beyond the famous temples, Khajuraho offers insights into ancient Indian culture, spirituality, and the sophisticated artistry that has captivated visitors for centuries.
              </p>
              ...
              <div className="package-details">
                ...
                <div className="detail-item">
                  ...
                  <span className="value">Temple Tour, Light Show</span>
                </div>
                <div className="detail-item">
                ...
                <div className="detail-item">
                  ...
                  <span className="value">Historical, Architectural, Cultural</span>
                </div>
              </div>
            </section>
            ...
            <section className="locations-section">
              ...
              <div className="locations-grid">
                <div className="location-card">
                  ...
                  <h3>Western Group Temples</h3>
                  <span className="duration">(02 Days)</span>
                </div>
                <div className="location-card">
                  <div className="location-icon">⚱️</div>
                  <h3>Eastern Group Temples</h3>
            ...
            <section className="highlights-section">
              ...
              <div className="highlights-list">
                <div className="highlight-item">
                  ...
                  Western Group Temples – UNESCO site with Kandariya Mahadeva Temple
                </div>
                <div className="highlight-item">
                  <span className="check">✓</span>
                  Intricate Sculptures – World-famous erotic and mythological carvings
                </div>
                <div className="highlight-item">
                  <span className="check">✓</span>
                  Sound & Light Show – Spectacular evening show narrating Khajuraho's history
                </div>
                <div className="highlight-item">
                  <span className="check">✓</span>
                  Eastern Group Temples – Jain temples with exquisite architecture
                </div>
                <div className="highlight-item">
                  <span className="check">✓</span>
                  Archaeological Museum – Preserving sculptures and artifacts from the region
                </div>
              </div>
            </section>
            ...
            <section className="itinerary-section">
              ...
              <div className="itinerary-list">
                <div className="departure-point">
                  <span className="location">Khajuraho, Madhya Pradesh</span>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Western Group Temples – Explore UNESCO World Heritage site</h4>
                </div>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Eastern Group Temples – Jain temples and architectural marvels</h4>
                </div>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Archaeological Museum – Ancient sculptures and artifacts</h4>
                </div>

                <div className="departure-point">
                  <span className="location">Khajuraho Town</span>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Sound & Light Show – Evening cultural experience</h4>
                </div>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Local Craft & Culture – Traditional arts and souvenir shopping</h4>
                </div>
              </div>
            </section>
          </div>
