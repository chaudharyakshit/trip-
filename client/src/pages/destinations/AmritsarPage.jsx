...
const AmritsarPage = () => {
  ...
  const amritsarImages = [amritsar1, amritsar2, amritsar3];
  ...
  return (
    <div className="inner-page">
      ...
      <section className="hero-section">
        ...
        >
          {amritsarImages.map((img, index) => (
            <SwiperSlide key={index}>
              <div className="hero-slide">
                <img
                  src={img}
                  alt={`Amritsar ${index + 1}`}
        ...
        <div className="content-grid">
          ...
          <div className="left-column">
            ...
            <section className="about-section">
              ...
              <p>
                Amritsar, the spiritual and cultural center of Sikhism, is home to the magnificent Golden Temple and offers a profound journey into Punjab's rich heritage. From the serene sanctity of the holiest Sikh shrine to the patriotic fervor of the Wagah Border ceremony and the vibrant local cuisine, this historic city provides an unforgettable experience of faith, history, and Punjabi culture.
              </p>
              ...
              <div className="package-details">
                ...
                <div className="detail-item">
                  ...
                  <span className="value">English, Hindi, Punjabi</span>
                </div>
                <div className="detail-item">
                  <span className="label">Activities</span>
                  <span className="value">Temple Visit, Border Ceremony</span>
                </div>
                <div className="detail-item">
                ...
                <div className="detail-item">
                  ...
                  <span className="value">Spiritual, Cultural, Historical</span>
                </div>
              </div>
            </section>
            ...
            <section className="highlights-section">
              ...
              <div className="highlights-list">
                <div className="highlight-item">
                  ...
                  Golden Temple – Holiest Sikh shrine with stunning gold architecture
                </div>
                <div className="highlight-item">
                  <span className="check">✓</span>
                  Wagah Border Ceremony – Patriotic retreat ceremony with Pakistan
                </div>
                <div className="highlight-item">
                  <span className="check">✓</span>
                  Langar Experience – Community kitchen serving free meals to all
                </div>
                <div className="highlight-item">
                  <span className="check">✓</span>
                  Jallianwala Bagh – Historic memorial of 1919 massacre
                </div>
                <div className="highlight-item">
                  <span className="check">✓</span>
                  Punjabi Cuisine – Authentic Amritsari food and local markets
                </div>
              </div>
            </section>
            ...
            <section className="itinerary-section">
              ...
              <div className="itinerary-list">
                <div className="departure-point">
                  <span className="location">Amritsar, Punjab</span>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Golden Temple – Morning visit and spiritual experience</h4>
                </div>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Wagah Border – Evening retreat ceremony experience</h4>
                </div>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Jallianwala Bagh – Historical memorial and museum visit</h4>
                </div>

                <div className="departure-point">
                  <span className="location">Amritsar City</span>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Local Markets – Shopping for handicrafts and Phulkari</h4>
                </div>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Punjabi Culture – Food tour and cultural evening</h4>
                </div>
              </div>
            </section>
          </div>
