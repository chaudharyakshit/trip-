...
const UdaipurPage = () => {
  ...
  const udaipurImages = [udaipur1, udaipur2, udaipur3];
        ...
        <div className="content-grid">
          ...
          <div className="left-column">
            ...
            <section className="about-section">
              ...
              <p>
                Udaipur, the "City of Lakes" and "Venice of the East," is a romantic paradise nestled in the Aravalli Hills of Rajasthan. With its magnificent palaces, serene lakes, and rich cultural heritage, Udaipur offers a royal experience that transports you to the era of Maharajas, making it one of India's most romantic destinations.
              </p>
              
              <div className="package-details">
                <div className="detail-item">
                  <span className="label">Accommodation</span>
                  <span className="value">Heritage Palace Hotel</span>
                </div>
                <div className="detail-item">
                  <span className="label">Meals</span>
                  <span className="value">Breakfast & Royal Dinner</span>
                </div>
                <div className="detail-item">
                  <span className="label">Transportation</span>
                  <span className="value">Boat, Car, Elephant</span>
                </div>
                <div className="detail-item">
                ...
                <div className="detail-item">
                  ...
                  <span className="value">Boat Ride, Cultural Show</span>
                </div>
                <div className="detail-item">
                ...
                <div className="detail-item">
                  ...
                  <span className="value">Romantic, Heritage, Luxury</span>
                </div>
              </div>
            </section>
            ...
            <section className="highlights-section">
              ...
              <div className="highlights-list">
                <div className="highlight-item">
                  ...
                  City Palace – Largest palace complex in Rajasthan with stunning architecture
                </div>
                <div className="highlight-item">
                  <span className="check">✓</span>
                  Lake Pichola Boat Ride – Romantic sunset cruise with Taj Lake Palace views
                </div>
                <div className="highlight-item">
                  <span className="check">✓</span>
                  Jag Mandir Palace – Island palace visit and royal dining experience
                </div>
                <div className="highlight-item">
                  <span className="check">✓</span>
                  Bagore Ki Haveli – Cultural dance show and traditional Rajasthani music
                </div>
                <div className="highlight-item">
                  <span className="check">✓</span>
                  Sahelion Ki Bari – Queen's pleasure garden with fountains and marble art
                </div>
              </div>
            </section>
            ...
            <section className="itinerary-section">
              ...
              <div className="itinerary-list">
                ...
                <div className="day-item completed">
                  ...
                  <h4>City Palace – Royal residence tour and museum visit</h4>
                </div>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Lake Pichola – Boat cruise and Taj Lake Palace viewing</h4>
                </div>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Jag Mandir – Island palace visit and royal lunch</h4>
                </div>

                <div className="departure-point">
                  <span className="location">Udaipur City</span>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Jagdish Temple & Old City – Heritage walk and shopping</h4>
                </div>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Cultural Evening – Bagore Ki Haveli dance show and dinner</h4>
                </div>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Sahelion Ki Bari & Fateh Sagar Lake – Garden tour and sunset</h4>
                </div>
              </div>
            </section>
          </div>
