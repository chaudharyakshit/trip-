...
const AgraPage = () => {
  ...
  const agraImages = [agra1, agra2, agra3];
        ...
        <div className="content-grid">
          ...
          <div className="left-column">
            ...
            <section className="about-section">
              ...
              <p>
                Agra, home to the magnificent Taj Mahal, offers a journey through India's rich Mughal heritage. From the eternal symbol of love to majestic forts and ancient tombs, this city provides an unforgettable experience of history, architecture, and romance.
              </p>
              ...
              <div className="package-details">
                ...
                <div className="detail-item">
                  ...
                  <span className="value">Elephant, Horse</span>
                </div>
                <div className="detail-item">
                ...
                <div className="detail-item">
                  ...
                  <span className="value">Heritage, Romantic</span>
                </div>
              </div>
            </section>
            ...
            <section className="highlights-section">
              ...
              <div className="highlights-list">
                <div className="highlight-item">
                  ...
                  Taj Mahal – Sunrise and sunset views of the eternal love monument
                </div>
                <div className="highlight-item">
                  <span className="check">✓</span>
                ...
                <div className="highlight-item">
                  <span className="check">✓</span>
                  Fatehpur Sikri – Abandoned Mughal city with stunning palaces
                </div>
                <div className="highlight-item">
                  <span className="check">✓</span>
                  Itmad-ud-Daulah – Beautiful tomb often called "Baby Taj"
                </div>
                <div className="highlight-item">
                  <span className="check">✓</span>
                  Mehtab Bagh – Moonlight garden with perfect Taj Mahal views
                </div>
              </div>
            </section>
            ...
            <section className="itinerary-section">
              ...
              <div className="itinerary-list">
                ...
                <div className="day-item completed">
                  ...
                  <h4>Taj Mahal – Sunrise visit and guided tour</h4>
                </div>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Agra Fort – Mughal architecture and history</h4>
                </div>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Itmad-ud-Daulah – The Baby Taj exploration</h4>
                </div>

                <div className="departure-point">
                  <span className="location">Fatehpur Sikri</span>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Fatehpur Sikri – Ancient Mughal city tour</h4>
                </div>
                ...
                <div className="day-item completed">
                  ...
                  <h4>Mehtab Bagh – Sunset views of Taj Mahal</h4>
                </div>
              </div>
            </section>
          </div>
          ...
          <div className="right-column">
            <div className="booking-widget">
              <div className="price-section">
                <a href="https://wa.me/919695947578?text=Hi, I'm interested in the Agra tour package. Please share the pricing details." target="_blank" className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-lg font-semibold text-lg transition-colors inline-block text-center w-full">
                  Price on Request
                </a>
              </div>
